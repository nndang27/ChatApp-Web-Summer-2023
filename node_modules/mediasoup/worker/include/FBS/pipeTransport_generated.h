...
struct PipeTransportOptions FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const FBS::Transport::ListenIp *listenIp() const {
    return GetPointer<const FBS::Transport::ListenIp *>(VT_LISTENIP);
  }
  uint16_t port() const {
...
struct PipeTransportOptionsBuilder {
  ...
  void add_listenIp(::flatbuffers::Offset<FBS::Transport::ListenIp> listenIp) {
...
inline ::flatbuffers::Offset<PipeTransportOptions> CreatePipeTransportOptions(
    ...
    ::flatbuffers::Offset<FBS::Transport::ListenIp> listenIp = 0,
    uint16_t port = 0,
