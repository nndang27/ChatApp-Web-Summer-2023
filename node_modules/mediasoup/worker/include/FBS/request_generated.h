...
enum class Method : uint8_t {
  ...
  TRANSPORT_CLOSE_DATA_PRODUCER = 33,
  TRANSPORT_CLOSE_DATA_CONSUMER = 34,
  PLAIN_TRANSPORT_CONNECT = 35,
  PIPE_TRANSPORT_CONNECT = 36,
  WEBRTC_TRANSPORT_CONNECT = 37,
  PRODUCER_DUMP = 38,
  ...
  DATA_PRODUCER_DUMP = 51,
  DATA_PRODUCER_GET_STATS = 52,
  DATA_CONSUMER_DUMP = 53,
  DATA_CONSUMER_GET_STATS = 54,
  DATA_CONSUMER_GET_BUFFERED_AMOUNT = 55,
  DATA_CONSUMER_SET_BUFFERED_AMOUNT_LOW_THRESHOLD = 56,
  DATA_CONSUMER_SEND = 57,
  RTP_OBSERVER_PAUSE = 58,
  RTP_OBSERVER_RESUME = 59,
  RTP_OBSERVER_ADD_PRODUCER = 60,
  RTP_OBSERVER_REMOVE_PRODUCER = 61,
  MIN = WORKER_CLOSE,
  MAX = RTP_OBSERVER_REMOVE_PRODUCER
};

inline const Method (&EnumValuesMethod())[62] {
  static const Method values[] = {
    ...
    Method::PLAIN_TRANSPORT_CONNECT,
    Method::PIPE_TRANSPORT_CONNECT,
    Method::WEBRTC_TRANSPORT_CONNECT,
...
enum class Body : uint8_t {
  ...
  FBS_PlainTransport_ConnectRequest = 26,
  FBS_PipeTransport_ConnectRequest = 27,
  ...
  FBS_RtpObserver_AddProducerRequest = 35,
  FBS_RtpObserver_RemoveProducerRequest = 36,
  MIN = NONE,
  MAX = FBS_RtpObserver_RemoveProducerRequest
};

inline const Body (&EnumValuesBody())[37] {
  static const Body values[] = {
    ...
    Body::FBS_PlainTransport_ConnectRequest,
    Body::FBS_PipeTransport_ConnectRequest,
...
inline const char * const *EnumNamesBody() {
  static const char * const names[38] = {
    ...
    "FBS_PlainTransport_ConnectRequest",
    "FBS_PipeTransport_ConnectRequest",
...
template<> struct BodyTraits<FBS::PlainTransport::ConnectRequest> {
  static const Body enum_value = Body::FBS_PlainTransport_ConnectRequest;
};

template<> struct BodyTraits<FBS::PipeTransport::ConnectRequest> {
  static const Body enum_value = Body::FBS_PipeTransport_ConnectRequest;
};
...
struct Request FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const FBS::PlainTransport::ConnectRequest *body_as_FBS_PlainTransport_ConnectRequest() const {
    return body_type() == FBS::Request::Body::FBS_PlainTransport_ConnectRequest ? static_cast<const FBS::PlainTransport::ConnectRequest *>(body()) : nullptr;
  }
  const FBS::PipeTransport::ConnectRequest *body_as_FBS_PipeTransport_ConnectRequest() const {
    return body_type() == FBS::Request::Body::FBS_PipeTransport_ConnectRequest ? static_cast<const FBS::PipeTransport::ConnectRequest *>(body()) : nullptr;
  }
...
inline bool VerifyBody(::flatbuffers::Verifier &verifier, const void *obj, Body type) {
  switch (type) {
    ...
    case Body::FBS_PlainTransport_ConnectRequest: {
      auto ptr = reinterpret_cast<const FBS::PlainTransport::ConnectRequest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Body::FBS_PipeTransport_ConnectRequest: {
...
inline const ::flatbuffers::TypeTable *MethodTypeTable() {
  ...
  static const ::flatbuffers::TypeTable tt = {
    ::flatbuffers::ST_ENUM, 62, type_codes, type_refs, nullptr, nullptr, names
  };
  return &tt;
}
