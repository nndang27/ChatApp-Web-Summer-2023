...
struct ListenIndividual FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<FBS::Transport::ListenIp>> *listenIps() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<FBS::Transport::ListenIp>> *>(VT_LISTENIPS);
  }
  uint16_t port() const {
...
struct ListenIndividualBuilder {
  ...
  void add_listenIps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<FBS::Transport::ListenIp>>> listenIps) {
    fbb_.AddOffset(ListenIndividual::VT_LISTENIPS, listenIps);
  }
  void add_port(uint16_t port) {
    fbb_.AddElement<uint16_t>(ListenIndividual::VT_PORT, port, 0);
  }
  ...
  ::flatbuffers::Offset<ListenIndividual> Finish() {
    ...
    fbb_.Required(o, ListenIndividual::VT_LISTENIPS);
    return o;
  }
};
...
inline ::flatbuffers::Offset<ListenIndividual> CreateListenIndividual(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<FBS::Transport::ListenIp>>> listenIps = 0,
    uint16_t port = 0) {
...
inline ::flatbuffers::Offset<ListenIndividual> CreateListenIndividualDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<::flatbuffers::Offset<FBS::Transport::ListenIp>> *listenIps = nullptr,
    uint16_t port = 0) {
  auto listenIps__ = listenIps ? _fbb.CreateVector<::flatbuffers::Offset<FBS::Transport::ListenIp>>(*listenIps) : 0;
...
inline const ::flatbuffers::TypeTable *ListenIndividualTypeTable() {
  ...
  static const ::flatbuffers::TypeFunction type_refs[] = {
    FBS::Transport::ListenIpTypeTable
  };
  static const char * const names[] = {
    "listenIps",
    "port"
