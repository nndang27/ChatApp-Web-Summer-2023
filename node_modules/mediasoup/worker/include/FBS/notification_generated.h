...
enum class Event : uint8_t {
  ...
  DATACONSUMER_DATAPRODUCER_CLOSE = 24,
  DATACONSUMER_MESSAGE = 25,
  ACTIVESPEAKEROBSERVER_DOMINANT_SPEAKER = 26,
  AUDIOLEVELOBSERVER_SILENCE = 27,
  AUDIOLEVELOBSERVER_VOLUMES = 28,
  MIN = TRANSPORT_SEND_RTCP,
  MAX = AUDIOLEVELOBSERVER_VOLUMES
};

inline const Event (&EnumValuesEvent())[29] {
  static const Event values[] = {
    Event::TRANSPORT_SEND_RTCP,
    Event::PRODUCER_SEND,
    Event::DATA_PRODUCER_SEND,
