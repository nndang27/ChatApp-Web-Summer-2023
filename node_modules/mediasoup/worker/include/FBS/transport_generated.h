...
inline const ::flatbuffers::TypeTable *ListenIpTypeTable();
...
struct ListenIp FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ListenIpBuilder Builder;
  static const ::flatbuffers::TypeTable *MiniReflectTypeTable() {
    return ListenIpTypeTable();
  }
...
struct ListenIpBuilder {
  typedef ListenIp Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ip(::flatbuffers::Offset<::flatbuffers::String> ip) {
    fbb_.AddOffset(ListenIp::VT_IP, ip);
  }
  void add_announcedIp(::flatbuffers::Offset<::flatbuffers::String> announcedIp) {
    fbb_.AddOffset(ListenIp::VT_ANNOUNCEDIP, announcedIp);
  }
  explicit ListenIpBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ListenIp> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ListenIp>(end);
    fbb_.Required(o, ListenIp::VT_IP);
    return o;
  }
};

inline ::flatbuffers::Offset<ListenIp> CreateListenIp(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> ip = 0,
    ::flatbuffers::Offset<::flatbuffers::String> announcedIp = 0) {
  ListenIpBuilder builder_(_fbb);
  builder_.add_announcedIp(announcedIp);
  builder_.add_ip(ip);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<ListenIp> CreateListenIpDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const char *ip = nullptr,
    const char *announcedIp = nullptr) {
  auto ip__ = ip ? _fbb.CreateString(ip) : 0;
  auto announcedIp__ = announcedIp ? _fbb.CreateString(announcedIp) : 0;
  return FBS::Transport::CreateListenIp(
      _fbb,
      ip__,
      announcedIp__);
}
...
struct DumpBuilder {
  ...
  void add_sctpState(::flatbuffers::Offset<::flatbuffers::String> sctpState) {
    fbb_.AddOffset(Dump::VT_SCTPSTATE, sctpState);
  }
...
struct Stats FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  uint64_t recvBitrate() const {
    return GetField<uint64_t>(VT_RECVBITRATE, 0);
  }
  uint64_t bytesSent() const {
    return GetField<uint64_t>(VT_BYTESSENT, 0);
  }
  uint64_t sendBitrate() const {
    return GetField<uint64_t>(VT_SENDBITRATE, 0);
  }
  uint64_t rtpBytesReceived() const {
    return GetField<uint64_t>(VT_RTPBYTESRECEIVED, 0);
  }
  uint64_t rtpRecvBitrate() const {
    return GetField<uint64_t>(VT_RTPRECVBITRATE, 0);
  }
  uint64_t rtpBytesSent() const {
    return GetField<uint64_t>(VT_RTPBYTESSENT, 0);
  }
  uint64_t rtpSendBitrate() const {
    return GetField<uint64_t>(VT_RTPSENDBITRATE, 0);
  }
  uint64_t rtxBytesReceived() const {
    return GetField<uint64_t>(VT_RTXBYTESRECEIVED, 0);
  }
  uint64_t rtxRecvBitrate() const {
    return GetField<uint64_t>(VT_RTXRECVBITRATE, 0);
  }
  uint64_t rtxBytesSent() const {
    return GetField<uint64_t>(VT_RTXBYTESSENT, 0);
  }
  uint64_t rtxSendBitrate() const {
    return GetField<uint64_t>(VT_RTXSENDBITRATE, 0);
  }
  uint64_t probationBytesSent() const {
    return GetField<uint64_t>(VT_PROBATIONBYTESSENT, 0);
  }
  uint64_t probationSendBitrate() const {
    return GetField<uint64_t>(VT_PROBATIONSENDBITRATE, 0);
  }
  uint64_t availableOutgoingBitrate() const {
    return GetField<uint64_t>(VT_AVAILABLEOUTGOINGBITRATE, 0);
  }
  uint64_t availableIncomingBitrate() const {
    return GetField<uint64_t>(VT_AVAILABLEINCOMINGBITRATE, 0);
  }
  uint64_t maxIncomingBitrate() const {
    return GetField<uint64_t>(VT_MAXINCOMINGBITRATE, 0);
  }
  uint64_t maxOutgoingBitrate() const {
    return GetField<uint64_t>(VT_MAXOUTGOINGBITRATE, 0);
  }
  uint64_t minOutgoingBitrate() const {
    return GetField<uint64_t>(VT_MINOUTGOINGBITRATE, 0);
  }
  uint64_t rtpPacketLossReceived() const {
    return GetField<uint64_t>(VT_RTPPACKETLOSSRECEIVED, 0);
  }
  uint64_t rtpPacketLossSent() const {
    return GetField<uint64_t>(VT_RTPPACKETLOSSSENT, 0);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint64_t>(verifier, VT_RECVBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_BYTESSENT, 8) &&
           VerifyField<uint64_t>(verifier, VT_SENDBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPBYTESRECEIVED, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPRECVBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPBYTESSENT, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPSENDBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTXBYTESRECEIVED, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTXRECVBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTXBYTESSENT, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTXSENDBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_PROBATIONBYTESSENT, 8) &&
           VerifyField<uint64_t>(verifier, VT_PROBATIONSENDBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_AVAILABLEOUTGOINGBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_AVAILABLEINCOMINGBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_MAXINCOMINGBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_MAXOUTGOINGBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_MINOUTGOINGBITRATE, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPPACKETLOSSRECEIVED, 8) &&
           VerifyField<uint64_t>(verifier, VT_RTPPACKETLOSSSENT, 8) &&
           verifier.EndTable();
  }
};
...
struct StatsBuilder {
  ...
  void add_sctpState(::flatbuffers::Offset<::flatbuffers::String> sctpState) {
    fbb_.AddOffset(Stats::VT_SCTPSTATE, sctpState);
  }
  void add_bytesReceived(uint64_t bytesReceived) {
    fbb_.AddElement<uint64_t>(Stats::VT_BYTESRECEIVED, bytesReceived, 0);
  }
  void add_recvBitrate(uint64_t recvBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_RECVBITRATE, recvBitrate, 0);
  }
  void add_bytesSent(uint64_t bytesSent) {
    fbb_.AddElement<uint64_t>(Stats::VT_BYTESSENT, bytesSent, 0);
  }
  void add_sendBitrate(uint64_t sendBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_SENDBITRATE, sendBitrate, 0);
  }
  void add_rtpBytesReceived(uint64_t rtpBytesReceived) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPBYTESRECEIVED, rtpBytesReceived, 0);
  }
  void add_rtpRecvBitrate(uint64_t rtpRecvBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPRECVBITRATE, rtpRecvBitrate, 0);
  }
  void add_rtpBytesSent(uint64_t rtpBytesSent) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPBYTESSENT, rtpBytesSent, 0);
  }
  void add_rtpSendBitrate(uint64_t rtpSendBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPSENDBITRATE, rtpSendBitrate, 0);
  }
  void add_rtxBytesReceived(uint64_t rtxBytesReceived) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTXBYTESRECEIVED, rtxBytesReceived, 0);
  }
  void add_rtxRecvBitrate(uint64_t rtxRecvBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTXRECVBITRATE, rtxRecvBitrate, 0);
  }
  void add_rtxBytesSent(uint64_t rtxBytesSent) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTXBYTESSENT, rtxBytesSent, 0);
  }
  void add_rtxSendBitrate(uint64_t rtxSendBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTXSENDBITRATE, rtxSendBitrate, 0);
  }
  ...
  void add_probationSendBitrate(uint64_t probationSendBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_PROBATIONSENDBITRATE, probationSendBitrate, 0);
  }
  void add_availableOutgoingBitrate(uint64_t availableOutgoingBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_AVAILABLEOUTGOINGBITRATE, availableOutgoingBitrate, 0);
  }
  void add_availableIncomingBitrate(uint64_t availableIncomingBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_AVAILABLEINCOMINGBITRATE, availableIncomingBitrate, 0);
  }
  void add_maxIncomingBitrate(uint64_t maxIncomingBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_MAXINCOMINGBITRATE, maxIncomingBitrate, 0);
  }
  void add_maxOutgoingBitrate(uint64_t maxOutgoingBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_MAXOUTGOINGBITRATE, maxOutgoingBitrate, 0);
  }
  void add_minOutgoingBitrate(uint64_t minOutgoingBitrate) {
    fbb_.AddElement<uint64_t>(Stats::VT_MINOUTGOINGBITRATE, minOutgoingBitrate, 0);
  }
  void add_rtpPacketLossReceived(uint64_t rtpPacketLossReceived) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPPACKETLOSSRECEIVED, rtpPacketLossReceived, 0);
  }
  void add_rtpPacketLossSent(uint64_t rtpPacketLossSent) {
    fbb_.AddElement<uint64_t>(Stats::VT_RTPPACKETLOSSSENT, rtpPacketLossSent, 0);
  }
...
inline ::flatbuffers::Offset<Stats> CreateStats(
    ...
    uint64_t recvBitrate = 0,
    uint64_t bytesSent = 0,
    uint64_t sendBitrate = 0,
    uint64_t rtpBytesReceived = 0,
    uint64_t rtpRecvBitrate = 0,
    uint64_t rtpBytesSent = 0,
    uint64_t rtpSendBitrate = 0,
    uint64_t rtxBytesReceived = 0,
    uint64_t rtxRecvBitrate = 0,
    uint64_t rtxBytesSent = 0,
    uint64_t rtxSendBitrate = 0,
    uint64_t probationBytesSent = 0,
    uint64_t probationSendBitrate = 0,
    uint64_t availableOutgoingBitrate = 0,
    uint64_t availableIncomingBitrate = 0,
    uint64_t maxIncomingBitrate = 0,
    uint64_t maxOutgoingBitrate = 0,
    uint64_t minOutgoingBitrate = 0,
    uint64_t rtpPacketLossReceived = 0,
    uint64_t rtpPacketLossSent = 0) {
  StatsBuilder builder_(_fbb);
  builder_.add_rtpPacketLossSent(rtpPacketLossSent);
  builder_.add_rtpPacketLossReceived(rtpPacketLossReceived);
  ...
  builder_.add_availableIncomingBitrate(availableIncomingBitrate);
  builder_.add_availableOutgoingBitrate(availableOutgoingBitrate);
