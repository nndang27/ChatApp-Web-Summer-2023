...
template<> struct DataTraits<FBS::DataConsumer::String> {
  static const Data enum_value = Data::String;
};

template<> struct DataTraits<FBS::DataConsumer::Binary> {
...
inline ::flatbuffers::Offset<String> CreateStringDirect(
  ...
  return FBS::DataConsumer::CreateString(
      _fbb,
      value__);
}
...
inline ::flatbuffers::Offset<Binary> CreateBinaryDirect(
  ...
  return FBS::DataConsumer::CreateBinary(
      _fbb,
      value__);
}
...
struct SendRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  FBS::DataConsumer::Data data_type() const {
    return static_cast<FBS::DataConsumer::Data>(GetField<uint8_t>(VT_DATA_TYPE, 0));
  }
  const void *data() const {
    return GetPointer<const void *>(VT_DATA);
  }
  template<typename T> const T *data_as() const;
  const FBS::DataConsumer::String *data_as_String() const {
    return data_type() == FBS::DataConsumer::Data::String ? static_cast<const FBS::DataConsumer::String *>(data()) : nullptr;
  }
  const FBS::DataConsumer::Binary *data_as_Binary() const {
    return data_type() == FBS::DataConsumer::Data::Binary ? static_cast<const FBS::DataConsumer::Binary *>(data()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const FBS::DataConsumer::String *SendRequest::data_as<FBS::DataConsumer::String>() const {
  return data_as_String();
}

template<> inline const FBS::DataConsumer::Binary *SendRequest::data_as<FBS::DataConsumer::Binary>() const {
...
struct SendRequestBuilder {
  ...
  void add_ppid(uint8_t ppid) {
    fbb_.AddElement<uint8_t>(SendRequest::VT_PPID, ppid, 0);
  }
  void add_data_type(FBS::DataConsumer::Data data_type) {
    fbb_.AddElement<uint8_t>(SendRequest::VT_DATA_TYPE, static_cast<uint8_t>(data_type), 0);
  }
...
inline ::flatbuffers::Offset<SendRequest> CreateSendRequest(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint8_t ppid = 0,
    FBS::DataConsumer::Data data_type = FBS::DataConsumer::Data::NONE,
...
inline bool VerifyData(::flatbuffers::Verifier &verifier, const void *obj, Data type) {
  switch (type) {
    ...
    case Data::String: {
      auto ptr = reinterpret_cast<const FBS::DataConsumer::String *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Data::Binary: {
      auto ptr = reinterpret_cast<const FBS::DataConsumer::Binary *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const ::flatbuffers::TypeTable *DataTypeTable() {
  ...
  static const ::flatbuffers::TypeFunction type_refs[] = {
    FBS::DataConsumer::StringTypeTable,
    FBS::DataConsumer::BinaryTypeTable
  };
...
inline const ::flatbuffers::TypeTable *SendRequestTypeTable() {
  ...
  static const ::flatbuffers::TypeFunction type_refs[] = {
    FBS::DataConsumer::DataTypeTable
  };
  static const char * const names[] = {
    "ppid",
    "data_type",
